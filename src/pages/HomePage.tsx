...
const HomePage: React.FC = () => {
    return (
        <div className="grid grid-cols-4 gap-4">
            ...
            <Item className="col-span-1 max-md:col-span-2" img_url="1.jpg" />
            <Item className="col-span-1 max-md:col-span-2" img_url="2.jpg" />
            ...
            <Item
                className="col-span-1 max-md:col-span-2 max-md:col-start-3 max-md:col-end-1"
                img_url="4.jpg"
            />
            <div className="md:hidden max-md:col-span-2"></div>
            <div className="md:hidden max-md:col-span-2"></div>
            <Item className="col-span-1 max-md:col-span-2" img_url="5.jpg" />
            ...
            {/*  */}
            <Item
                className="col-span-1 mb-20 max-md:col-span-2 max-h-[300px] max-md:h-[230px]"
                img_url="11.jpg"
            >
                <p>Yashica T5</p>
            </Item>
            <Item
                className="col-span-1 max-md:col-span-2 max-h-[300px] max-md:h-[230px]"
                img_url="12.jpg"
            >
                <p>Yashica T5</p>
            </Item>
            <Item
                className="col-span-1 mb-20 max-md:col-span-2 max-md:h-[230px] h-[300px]"
                img_url="13.jpg"
            >
                <p>Yashica T5</p>
            </Item>
            <Item
                className="col-span-1 mb-20 max-md:col-span-2 h-[300px] w-auto max-md:h-[230px]"
                img_url="white.jpg"
            >
                <p>more</p>
            </Item>
